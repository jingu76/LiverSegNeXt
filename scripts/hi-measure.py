...
class Evaluation:
    ...
    def evaluate(self):
        ...
        if args.parallel:
            logger.info(f'***Warning: multiprocessing model is on, thread number: {args.thread_num}')
            ...
            logger.info('***Warning: multiprocessing model is off')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt_dir', type=str, default=r"/data4/liver_CT4_Z2_ts2.2")
