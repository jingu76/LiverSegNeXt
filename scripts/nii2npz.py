...
def nii2npz(nii_path, npz_label_dir, output_dir, phase_idx, preview_dir=None):
    ...
    out_array[liver_mask[phase_idx] == 0] = 0  # 用肝mask裁剪
...
def main(args):
    output_dir = args.input_dir.rsplit('/', 1)[0] + "/outputs_npz"
    ...
    for file_name in file_list:
        ...
        args_list.append([nii_path, args.npz_label_dir, output_dir, args.phase_idx, args.preview_dir])
    pool = Pool(20)
