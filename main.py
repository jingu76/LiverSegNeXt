...
from networks.MedNeXt import MedNeXt,get_mednet
...
parser.add_argument(
    "--CUDA_VISIBLE_DEVICES", default="0,1,2,3", type=str, help="显卡环境"
)
parser.add_argument(
    "--pretrained_path", default="/home/huhaoyu/project/MedNeXt/SwinUNETR2Med/log/model_final.pt", type=str, help="pretrained checkpoint directory"
)
parser.add_argument("--debug", action="store_true", help="faster training for debuging")
parser.add_argument("--ngpus_per_node", default=1, type=int, help="number of GPU used")
parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
# hhy修改:去掉日志，没有权限写日志功能
...
parser.add_argument("--data_dir", default="/data4/ycy/datasets/nifty/abdomen/", type=str, help="dataset directory")
...
parser.add_argument("--dist-url", default="tcp://127.0.0.1:4567", type=str, help="distributed url")
...
def main_worker(gpu, args):
    ...
    if args.use_ssl_pretrained:
        try:
            # ssl_pretrained_path = "./pretrained_models/model.pt"pretrained_path
            ssl_pretrained_path = args.pretrained_path
    ...
    model_inferer = partial(
        ...
        roi_size=inf_size,#[x,y,z]，即[128 128 128] 
